...
function grabProminentHero(options, $)
{
  console.log($(".masthead-hero-image").attr("data-hero-quickplay"));
  console.log($(".masthead-hero-image").css("background-image"));
  return {
    name: $(".masthead-hero-image").attr("data-hero-quickplay"),
    imageURL: $(".masthead-hero-image").css("background-image")
  };
}
...
export function scrapePlayerStats (options, html) {
  ...
  stats.prominentHero = grabProminentHero(options, p);
